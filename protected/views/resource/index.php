            ...
            <section id="j-write" class="offset2 block well">
              ...
              <form action="" method="POST" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" value="" name="Resource[title]" placeholder="标题不超过20个字" class="title">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label"><span style="color:red">*</span>资源描述</label>
                  <div class="controls">
                    <textarea rows="5" name="Resource[description]" placeholder="请尽量保证您的描述简要、精辟" class="span9"></textarea>
                  </div>
                </div>
                <div class="control-group">
                  ...
                  <div class="controls">
                    ...
                    <p class="help-block muted">附件和外部链接必须选其一，文件大小不能超过2M，格式只能是jpg、gif、jepg、bmp格式之一</p>
                  </div>
                </div>
                <div class="control-group">
